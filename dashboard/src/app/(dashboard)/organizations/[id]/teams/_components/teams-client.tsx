...
export default function TeamsClient({ orgId, initialTeams, initialPool }: {
  orgId: string
  initialTeams: Team[]
  initialPool: AvailableMember[]
}) {
  ...
  const [availablePool, setAvailablePool] = useState<AvailableMember[]>(initialPool)
