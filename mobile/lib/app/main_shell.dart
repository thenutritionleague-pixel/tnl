...
class MainShell extends StatelessWidget {
  ...
  int _currentIndex(BuildContext context) {
    ...
    // if (location.startsWith('/feed')) return 3; // feed tab hidden
    return 3; // more
  }
      ...
      bottomNavigationBar: NavigationBar(
        ...
        onDestinationSelected: (index) {
          switch (index) {
            ...
            // case 3: context.go('/feed'); // feed tab hidden
        ...
        destinations: const [
          ...
          // NavigationDestination(icon: Icon(Icons.dynamic_feed_outlined), selectedIcon: Icon(Icons.dynamic_feed_rounded), label: 'Feed'), // hidden
